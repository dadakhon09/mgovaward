...
from app.pharmacy.views import PharmacyList, PharmacyDetail, MedicinePharmacyRelList, MedicinePharmacyRelDetail, \
    PharmacyCreate, MedicinePharmacyRelCreate, PharmacyListByMedicine
...
urlpatterns = [
    ...
    path('list/medicine/<int:medicine_id>/', PharmacyListByMedicine.as_view(), name='pharmacy-list-by-medicine'),
